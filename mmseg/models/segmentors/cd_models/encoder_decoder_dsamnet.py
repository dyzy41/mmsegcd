...
class Dsamnet(BaseSegmentor):
    ...
    def __init__(self,
        ...
        self.backbone = Backbone(in_ch=3, arch='resnet34', strides=(1,1,2,2,1))
        self.decoder = Decoder(64)

        self.cbam1 = CBAM(64, ratio=8, kernel_size=7)
        self.cbam2 = CBAM(64, ratio=8, kernel_size=7)

        self.dsl2 = DSLayer(64, 2, 32, stride=2, output_padding=1)
        self.dsl3 = DSLayer(128, 2, 32, stride=4, output_padding=3)
