...
class EncoderDecoderCDLoss(BaseSegmentor):
    ...
    def encode_decode(self, inputs: Tensor,
        ...
        x, encode_features = self.extract_feat(inputs)
        seg_logits = self.decode_head.predict(x, batch_img_metas,
                                              self.test_cfg)

        return seg_logits

    def _decode_head_forward_train(self, inputs: List[Tensor], encode_features, 
                                   data_samples: SampleList) -> dict:
        """Run forward function and calculate loss for decode head in
        training."""
        losses = dict()
        loss_decode = self.decode_head.loss(inputs, data_samples,
                                            self.train_cfg, encode_features)
    ...
    def loss(self, inputs: Tensor, data_samples: SampleList) -> dict:
        ...
        loss_decode = self._decode_head_forward_train(x, encode_features, data_samples)
